...
class ExerciseVariationDaoTest {
    ...
    @Test
    fun testUniqueConstraint_preventsDuplicateNames() =
        runBlocking<Unit> {
    ...
    @Test
    fun testInsertVariations_allowsDifferentNames() =
        runBlocking<Unit> {
    ...
    @Test
    fun testFindVariationByName_isCaseInsensitive() =
        runBlocking<Unit> {
    ...
    @Test
    fun testBatchInsert_ignoresDuplicates() =
        runBlocking<Unit> {
