...
class ProgrammeTextParserTest {
    ...
    private inner class TestProgrammeTextParser(
        ...
        override fun callOpenAIAPI(request: TextParsingRequest): String {
            return mockApiResponse ?: error("No mock response set")
        }
    ...
    // Validation Tests
    @Test
    fun parseText_withBlankText_returnsValidationError() = runTest {
    ...
    @Test
    fun parseText_withOnlyWhitespace_returnsValidationError() = runTest {
        val request = TextParsingRequest(
            rawText = "   \n  \t  ",
            userMaxes = emptyMap()
        )
    ...
    @Test
    fun parseText_withTextOver10000Characters_returnsValidationError() = runTest {
    ...
    @Test
    fun parseText_withTextExactly10000Characters_passesValidation() = runTest {
    ...
    @Test
    fun parseText_withSimpleProgramme_parsesProperly() = runTest {
        val request = TextParsingRequest(
            rawText = """
                Week 1
                Day 1
    ...
    @Test
    fun parseText_withMultipleWeeks_parsesAllWeeks() = runTest {
        val request = TextParsingRequest(
    ...
    @Test
    fun parseText_withRPEValues_parsesRPECorrectly() = runTest {
        val request = TextParsingRequest(
        ...
        assertThat(result.success).isTrue()
        val sets = result.programme?.weeks?.first()?.workouts?.first()?.exercises?.first()?.sets
    ...
    @Test
    fun parseText_withDuplicateExercisesInJson_mergesSetsCorrectly() = runTest {
        val request = TextParsingRequest(
        ...
        assertThat(result.success).isTrue()
        val exercises = result.programme?.weeks?.first()?.workouts?.first()?.exercises
    ...
    @Test
    fun parseText_withNullDayValue_handlesCorrectly() = runTest {
        val request = TextParsingRequest(
        ...
        assertThat(result.success).isTrue()
        val workouts = result.programme?.weeks?.first()?.workouts
    ...
    @Test
    fun parseText_withInvalidJson_returnsError() = runTest {
        val request = TextParsingRequest(
    ...
    @Test
    fun parseText_withEmptyJsonResponse_returnsError() = runTest {
        val request = TextParsingRequest(
            rawText = "Test programme",
            userMaxes = emptyMap()
        )
    ...
    @Test
    fun parseText_withMissingRequiredFields_usesDefaults() = runTest {
        val request = TextParsingRequest(
        ...
        val exercise = result.programme?.weeks?.first()?.workouts?.first()?.exercises?.first()
        assertThat(exercise?.exerciseName).isEqualTo("Unknown Exercise")
    }

    @Test
    fun parseText_withParsingLogic_logsButDoesNotAffectParsing() = runTest {
        val request = TextParsingRequest(
    ...
    @Test
    fun parseText_withComplexSetNotation_parsesAllSets() = runTest {
        val request = TextParsingRequest(
    ...
    @Test
    fun parseText_withFloatWeights_parsesCorrectly() = runTest {
        val request = TextParsingRequest(
    ...
    @Test
    fun parseText_withEmptyExerciseList_handlesGracefully() = runTest {
        val request = TextParsingRequest(
    ...
    @Test
    fun parseText_withEstimatedDuration_parsesCorrectly() = runTest {
        val request = TextParsingRequest(
    ...
    @Test
    fun parseText_withMissingEstimatedDuration_usesDefault() = runTest {
        val request = TextParsingRequest(
        ...
        assertThat(result.success).isTrue()
        val workout = result.programme?.weeks?.first()?.workouts?.first()
