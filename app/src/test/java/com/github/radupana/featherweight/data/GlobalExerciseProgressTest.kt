...
class GlobalExerciseProgressTest {
    ...
    fun globalExerciseProgress_allProgressTrendValues_areValid() {
        ...
        val improving = GlobalExerciseProgress(
        ...
        val stalling = GlobalExerciseProgress(
            exerciseVariationId = 1L,
            currentWorkingWeight = 100f,
            estimatedMax = 120f,
            lastUpdated = baseDate,
        ...
        val declining = GlobalExerciseProgress(
            exerciseVariationId = 1L,
            currentWorkingWeight = 100f,
            estimatedMax = 120f,
            lastUpdated = baseDate,
    ...
    fun globalExerciseProgress_allVolumeTrendValues_areValid() {
        ...
        val increasing = GlobalExerciseProgress(
            exerciseVariationId = 1L,
            currentWorkingWeight = 100f,
            estimatedMax = 120f,
            lastUpdated = baseDate,
        ...
        val maintaining = GlobalExerciseProgress(
            exerciseVariationId = 1L,
            currentWorkingWeight = 100f,
            estimatedMax = 120f,
            lastUpdated = baseDate,
        ...
        val decreasing = GlobalExerciseProgress(
            exerciseVariationId = 1L,
            currentWorkingWeight = 100f,
            estimatedMax = 120f,
            lastUpdated = baseDate,
    ...
    fun globalExerciseProgress_equality_basedOnAllFields() {
        ...
        val progress1 = GlobalExerciseProgress(
            id = 1L,
            exerciseVariationId = 100L,
            currentWorkingWeight = 100f,
            estimatedMax = 120f,
        ...
        val progress2 = GlobalExerciseProgress(
            id = 1L,
            exerciseVariationId = 100L,
            currentWorkingWeight = 100f,
            estimatedMax = 120f,
        ...
        val progress3 = GlobalExerciseProgress(
            id = 2L, // Different ID
            exerciseVariationId = 100L,
            currentWorkingWeight = 100f,
            estimatedMax = 120f,
    ...
    fun globalExerciseProgress_copy_createsIndependentInstance() {
        val original = GlobalExerciseProgress(
            exerciseVariationId = 100L,
            currentWorkingWeight = 100f,
            estimatedMax = 120f,
            lastUpdated = LocalDateTime.now(),
