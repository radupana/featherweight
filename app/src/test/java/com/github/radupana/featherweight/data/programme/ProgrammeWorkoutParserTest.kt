...
class ProgrammeWorkoutParserTest {
    ...
    fun calculateWeight_withSquatExercise_shouldUseSquatMax() {
        ...
        val weight = ProgrammeWorkoutParser.calculateWeight(
            "Barbell Squat",
            80,
            userMaxes,
            45f
    ...
    fun calculateWeight_roundsToNearest2_5kg() {
        ...
        val weight1 = ProgrammeWorkoutParser.calculateWeight(
            "Squat",
        ...
        val weight2 = ProgrammeWorkoutParser.calculateWeight(
            "Squat",
        ...
        val weight3 = ProgrammeWorkoutParser.calculateWeight(
            "Squat",
    ...
    fun workoutStructureWithWeek_shouldWrapCorrectly() {
        ...
        val wrapped = WorkoutStructureWithWeek(
    ...
    fun progressionStructure_withAllFields_shouldStoreCorrectly() {
        val progression = ProgressionStructure(
            type = "5/3/1",
            increment = IncrementStructure.PerExercise(
