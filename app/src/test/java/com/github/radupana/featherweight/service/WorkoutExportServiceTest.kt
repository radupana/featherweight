...
class WorkoutExportServiceTest {
    ...
    @Test
    fun exportWorkoutsToFile_withNoWorkouts_createsEmptyExport() = runBlocking {
        // Arrange
        ...
        coEvery { 
            workoutDao.getWorkoutsInDateRangePaged(
                startDate, endDate, WorkoutStatus.NOT_STARTED, 50, 0
            ) 
        } returns emptyList()
        ...
        // Act
        val result = service.exportWorkoutsToFile(
            context = context,
            startDate = startDate,
            endDate = endDate,
    ...
    @Test
    fun exportWorkoutsToFile_withSingleWorkout_exportsCorrectly() = runBlocking {
        // Arrange
        val startDate = LocalDateTime.of(2024, 1, 1, 0, 0)
        val endDate = LocalDateTime.of(2024, 12, 31, 23, 59)
        val exportOptions = ExportOptions(
        ...
        coEvery { 
            workoutDao.getWorkoutsInDateRangePaged(
                startDate, endDate, WorkoutStatus.NOT_STARTED, 50, 50
            ) 
        } returns emptyList()
    ...
    @Test
    fun exportWorkoutsToFile_withProgrammeWorkout_includesProgrammeInfo() = runBlocking {
        // Arrange
        val startDate = LocalDateTime.of(2024, 1, 1, 0, 0)
        val endDate = LocalDateTime.of(2024, 12, 31, 23, 59)
        val exportOptions = ExportOptions(
    ...
    @Test
    fun exportWorkoutsToFile_withOneRepMaxes_includesUserProfile() = runBlocking {
        // Arrange
        val startDate = LocalDateTime.of(2024, 1, 1, 0, 0)
        val endDate = LocalDateTime.of(2024, 12, 31, 23, 59)
        val exportOptions = ExportOptions(
        ...
        val oneRM1 = UserExerciseMaxWithName(
            id = 1,
        ...
        val oneRM2 = UserExerciseMaxWithName(
            id = 2,
    ...
    @Test
    fun exportWorkoutsToFile_withBodyweightOption_includesEmptyBodyweightHistory() = runBlocking {
        // Arrange
        val startDate = LocalDateTime.of(2024, 1, 1, 0, 0)
        val endDate = LocalDateTime.of(2024, 12, 31, 23, 59)
        val exportOptions = ExportOptions(
    ...
    @Test
    fun exportWorkoutsToFile_withLargeDataset_paginatesCorrectly() = runBlocking {
        // Arrange
        val startDate = LocalDateTime.of(2024, 1, 1, 0, 0)
        val endDate = LocalDateTime.of(2024, 12, 31, 23, 59)
        val exportOptions = ExportOptions(
        ...
        val firstPageWorkouts = (1..50).map { id ->
            Workout(
                id = id.toLong(),
        ...
        val secondPageWorkouts = (51..100).map { id ->
            Workout(
                id = id.toLong(),
        ...
        val thirdPageWorkouts = (101..120).map { id ->
            Workout(
                id = id.toLong(),
        ...
        coEvery { 
            workoutDao.getWorkoutsInDateRangePaged(
                startDate, endDate, WorkoutStatus.NOT_STARTED, 50, 100
            ) 
        } returns thirdPageWorkouts
        
        coEvery { 
            workoutDao.getWorkoutsInDateRangePaged(
                startDate, endDate, WorkoutStatus.NOT_STARTED, 50, 150
            ) 
        } returns emptyList()
    ...
    @Test
    fun exportWorkoutsToFile_withSuperset_exportsSupersetGroup() = runBlocking {
        // Arrange
        val startDate = LocalDateTime.of(2024, 1, 1, 0, 0)
        val endDate = LocalDateTime.of(2024, 12, 31, 23, 59)
        val exportOptions = ExportOptions(
        ...
        val exerciseVariation1 = ExerciseVariation(
            id = 10,
            coreExerciseId = 1,
            name = "Bench Press",
            equipment = Equipment.BARBELL,
        ...
        val exerciseVariation2 = ExerciseVariation(
            id = 11,
            coreExerciseId = 2,
            name = "Barbell Row",
            equipment = Equipment.BARBELL,
    ...
    @Test
    fun exportWorkoutsToFile_withNotesDisabled_excludesNotes() = runBlocking {
        // Arrange
        val startDate = LocalDateTime.of(2024, 1, 1, 0, 0)
        val endDate = LocalDateTime.of(2024, 12, 31, 23, 59)
        val exportOptions = ExportOptions(
    ...
    @Test
    fun exportWorkoutsToFile_withUnknownExercise_handlesGracefully() = runBlocking {
        // Arrange
        val startDate = LocalDateTime.of(2024, 1, 1, 0, 0)
        val endDate = LocalDateTime.of(2024, 12, 31, 23, 59)
        val exportOptions = ExportOptions(
    ...
    @Test
    fun exportWorkoutsToFile_withIncompleteWorkout_exportsCorrectly() = runBlocking {
        // Arrange
        val startDate = LocalDateTime.of(2024, 1, 1, 0, 0)
        val endDate = LocalDateTime.of(2024, 12, 31, 23, 59)
        val exportOptions = ExportOptions(
