...
class WorkoutDaoTest {
    ...
    @Test
    fun `insertWorkout_validWorkout_returnsId`() = runTest {
        // Arrange
    ...
    @Test
    fun `updateWorkout_existingWorkout_updatesSuccessfully`() = runTest {
        // Arrange
    ...
    @Test
    fun `getAllWorkouts_hasWorkouts_returnsListSortedByDateDesc`() = runTest {
        // Arrange
        val workouts = listOf(
    ...
    @Test
    fun `getAllWorkouts_noWorkouts_returnsEmptyList`() = runTest {
        // Arrange
    ...
    @Test
    fun `getWorkoutById_nonExistentId_returnsNull`() = runTest {
        // Arrange
    ...
    @Test
    fun `getWorkoutsInDateRange_validRange_returnsFilteredWorkouts`() = runTest {
        // Arrange
    ...
    @Test
    fun `deleteWorkout_existingWorkout_deletesSuccessfully`() = runTest {
        // Arrange
    ...
    @Test
    fun `deleteWorkoutsByProgramme_validProgrammeId_deletesAllRelatedWorkouts`() = runTest {
        // Arrange
    ...
    @Test
    fun `getInProgressWorkoutCountByProgramme_hasSomeInProgress_returnsCorrectCount`() = runTest {
        // Arrange
    ...
    @Test
    fun `getWorkoutsByProgramme_validProgrammeId_returnsProgrammeWorkouts`() = runTest {
        // Arrange
        val programmeWorkouts = listOf(
    ...
    @Test
    fun `getProgrammeWorkoutsByWeek_validWeek_returnsWeekWorkouts`() = runTest {
        // Arrange
    ...
    @Test
    fun `getFreestyleWorkouts_hasFreestyleWorkouts_returnsNonProgrammeWorkouts`() = runTest {
        // Arrange
        val freestyleWorkouts = listOf(
    ...
    @Test
    fun `getProgrammeWorkouts_hasProgrammeWorkouts_returnsProgrammeWorkoutsOnly`() = runTest {
        // Arrange
        val programmeWorkouts = listOf(
    ...
    @Test
    fun `getCompletedProgrammeWorkoutCount_validProgramme_returnsCount`() = runTest {
        // Arrange
    ...
    @Test
    fun `getTotalProgrammeWorkoutCount_validProgramme_returnsTotal`() = runTest {
        // Arrange
    ...
    @Test
    fun `getCompletedWeeksForProgramme_hasCompletedWeeks_returnsWeekNumbers`() = runTest {
        // Arrange
    ...
    @Test
    fun `getExerciseLogsByVariationId_validId_returnsLogs`() = runTest {
        // Arrange
        val logs = listOf(
    ...
    @Test
    fun `getSetsForExercisesInRepRange_validRange_returnsFilteredSets`() = runTest {
        // Arrange
        val sets = listOf(
    ...
    @Test
    fun `getRecentSetsForExercises_withLimit_returnsLimitedSets`() = runTest {
        // Arrange
        val sets = listOf(
    ...
    @Test
    fun `getSetsForExercisesInWeightRange_validRange_returnsFilteredSets`() = runTest {
        // Arrange
        val sets = listOf(
    ...
    @Test
    fun `deleteAllWorkouts_called_deletesAll`() = runTest {
        // Arrange
    ...
    @Test
    fun `getCompletedWorkoutsPaged_withPagination_returnsPagedResults`() = runTest {
        // Arrange
        val workouts = listOf(
    ...
    @Test
    fun `getWorkoutDateForMaxWeight_validParams_returnsDate`() = runTest {
        // Arrange
    ...
    @Test
    fun `getWorkoutCountsByDateRange_validRange_returnsCounts`() = runTest {
        // Arrange
        val counts = listOf(
    ...
    @Test
    fun `getCompletedWorkoutCountsByDateRange_validRange_returnsCompletedCounts`() = runTest {
        // Arrange
        val counts = listOf(
    ...
    @Test
    fun `getWorkoutCountsByDateRangeWithStatus_validRange_returnsStatusCounts`() = runTest {
        // Arrange
        val counts = listOf(
    ...
    @Test
    fun `getWorkoutsByWeek_validWeek_returnsWeekWorkouts`() = runTest {
        // Arrange
    ...
    @Test
    fun `searchWorkouts_withQuery_returnsMatchingWorkouts`() = runTest {
        // Arrange
        val workouts = listOf(
    ...
    @Test
    fun `getWorkoutsInDateRangePaged_validParams_returnsPagedWorkouts`() = runTest {
        // Arrange
        val workouts = listOf(
            mockWorkout.copy(status = WorkoutStatus.COMPLETED)
        )
        ...
        // Act
        val result = dao.getWorkoutsInDateRangePaged(
            testDate,
            testDate.plusDays(7),
            WorkoutStatus.NOT_STARTED,
            10,
    ...
    @Test
    fun `getWorkoutCountInDateRange_validRange_returnsCount`() = runTest {
        // Arrange
        coEvery { 
        ...
        // Act
        val result = dao.getWorkoutCountInDateRange(
            testDate,
            testDate.plusDays(7),
            WorkoutStatus.NOT_STARTED
        )
