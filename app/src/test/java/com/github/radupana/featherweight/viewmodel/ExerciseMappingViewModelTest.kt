...
class ExerciseMappingViewModelTest {
    ...
    @Test
    fun `searchExercises with blank query returns empty list`() = runTest {
        // When
    ...
    @Test
    fun `searchExercises with 'Barbell Squat' finds all barbell squat variations`() = runTest {
        // When
    ...
    @Test
    fun `searchExercises with 'squat' finds all squat exercises`() = runTest {
        // When
    ...
    @Test
    fun `searchExercises does not find exercises missing search terms`() = runTest {
    ...
    @Test
    fun `searchExercises handles partial word matches`() = runTest {
    ...
    @Test
    fun `searchExercises is case insensitive`() = runTest {
        // When
        viewModel.searchExercises("BARBELL SQUAT")
    ...
    @Test
    fun `searchExercises respects MAX_SEARCH_RESULTS limit`() = runTest {
        // Create a large list of exercises
        val manyExercises = (1..30).map { i ->
            ExerciseVariation(
                id = i.toLong(),
                coreExerciseId = 1,
    ...
    @Test
    fun `clearSearch clears search results`() = runTest {
    ...
    @Test
    fun `searchExercises sorts results by relevance`() = runTest {
        // Add an exact match to test sorting
        val exercisesWithExactMatch = testExercises + ExerciseVariation(
            id = 7,
            coreExerciseId = 1,
    ...
    @Test
    fun `mapExercise adds mapping to UI state`() = runTest {
        // When
    ...
    @Test
    fun `clearMapping removes mapping from UI state`() = runTest {
        // Given
        viewModel.mapExercise(
            originalName = "Custom Squat",
            exerciseId = 1L,
    ...
    @Test
    fun `allExercisesMapped returns true when all exercises are mapped`() = runTest {
        // Given
    ...
    @Test
    fun `allExercisesMapped returns false when some exercises are not mapped`() = runTest {
        // Given
    ...
    @Test
    fun `getFinalMappings returns correct mapping structure`() = runTest {
        // Given
