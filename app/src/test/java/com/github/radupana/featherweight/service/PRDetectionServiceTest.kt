...
class PRDetectionServiceTest {
    ...
    @Test
    fun `checkForPR with weighted bodyweight scaling type`() = runTest {
        // Arrange
        val setLog = WorkoutFixtures.createSetLog(
    ...
    @Test
    fun `checkForPR with isolation exercise scaling type`() = runTest {
        // Arrange
        val setLog = WorkoutFixtures.createSetLog(
            actualWeight = 15f,  
            actualReps = 12,
    ...
    @Test
    fun `checkForPR skips 1RM calculation when RPE is 6 or below`() = runTest {
        // Arrange
        val setLog = WorkoutFixtures.createSetLog(
            actualWeight = 80f,
            actualReps = 10,
    ...
    @Test
    fun `checkForPR handles duplicate PR in same workout`() = runTest {
        // Arrange
        val setLog = WorkoutFixtures.createSetLog(
            actualWeight = 100f,
            actualReps = 5,
        ...
        val existingPRInWorkout = PersonalRecord(
            id = 10,
            exerciseVariationId = exerciseVariationId,
    ...
    @Test
    fun `checkForPR handles date parsing error gracefully`() = runTest {
        // Arrange
        val setLog = WorkoutFixtures.createSetLog(
            actualWeight = 100f,
            actualReps = 5,
    ...
    @Test
    fun `checkForPR calculates correct improvement percentage`() = runTest {
        // Arrange
        val setLog = WorkoutFixtures.createSetLog(
    ...
    @Test
    fun `checkForPR generates helpful notes for potential improvement`() = runTest {
        // Arrange
        val setLog = WorkoutFixtures.createSetLog(
    ...
    @Test
    fun `checkForPR with more than 15 total rep capacity skips 1RM`() = runTest {
        // Arrange
        val setLog = WorkoutFixtures.createSetLog(
            actualWeight = 50f,
            actualReps = 15,
    ...
    @Test
    fun `checkForPR handles null workout date`() = runTest {
        // Arrange
        val setLog = WorkoutFixtures.createSetLog(
            actualWeight = 100f,
            actualReps = 5,
    ...
    @Test
    fun `checkForPR with true 1 rep max`() = runTest {
        // Arrange
        val setLog = WorkoutFixtures.createSetLog(
            actualWeight = 140f,
            actualReps = 1,
    ...
    @Test
    fun `getRecentPRsForExercise returns PRs for specific exercise`() = runTest {
        // Arrange
        val exerciseVariationId = 1L
        val limit = 5
    ...
    @Test
    fun `getRecentPRsForExercise with default limit`() = runTest {
        // Arrange
        val exerciseVariationId = 1L
    ...
    @Test
    fun `getRecentPRs returns all recent PRs`() = runTest {
        // Arrange
        val limit = 10
        val expectedPRs = listOf(
            PersonalRecord(
    ...
    @Test
    fun `getRecentPRs with default limit`() = runTest {
        // Arrange
        val expectedPRs = emptyList<PersonalRecord>()
    ...
    @Test
    fun `checkForPR doesnt duplicate 1RM PR when weight PR includes same 1RM`() = runTest {
        // Arrange
        val setLog = WorkoutFixtures.createSetLog(
            actualWeight = 100f,
            actualReps = 3,
    ...
    @Test
    fun `checkForPR handles null exercise variation gracefully`() = runTest {
        // Arrange
        val setLog = WorkoutFixtures.createSetLog(
            actualWeight = 100f,
            actualReps = 5,
