...
class ExerciseRepositoryTest {
    ...
    @Test
    fun `getAllExercises_returnsAllExercises`() = runTest {
        // Arrange
    ...
    @Test
    fun `getAllExercisesWithAliases_returnsVariationsWithAliases`() = runTest {
        // Arrange
    ...
    @Test
    fun `getAllExerciseNamesIncludingAliases_returnsDistinctSortedNames`() = runTest {
        // Arrange
        ...
        assertThat(result).containsExactly(
            "BP", "Barbell Bench Press", "DB Press", "Dumbbell Press"
        ).inOrder()
    }
    
    @Test
    fun `getAllExerciseAliases_returnsAllAliases`() = runTest {
        // Arrange
        val aliases = listOf(
            VariationAlias(id = 1L, variationId = 1L, alias = "BP"),
    ...
    @Test
    fun `getAllExercisesWithUsageStats_returnsSortedByUsageAndName`() = runTest {
        // Arrange
    ...
    @Test
    fun `getExerciseByName_exactMatch_returnsExercise`() = runTest {
        // Arrange
    ...
    @Test
    fun `getExerciseByName_aliasMatch_returnsExercise`() = runTest {
        // Arrange
    ...
    @Test
    fun `searchExercises_returnsMatchingExercises`() = runTest {
        // Arrange
    ...
    @Test
    fun `getExercisesByCategory_returnsFilteredExercises`() = runTest {
        // Arrange
    ...
    @Test
    fun `getExercisesByMuscleGroup_returnsFilteredExercises`() = runTest {
        // Arrange
        val exercises = listOf(mockVariation)
    ...
    @Test
    fun `getExercisesByEquipment_returnsFilteredExercises`() = runTest {
        // Arrange
        val exercises = listOf(mockVariation)
    ...
    @Test
    fun `getBig4Exercises_returnsFoundExercises`() = runTest {
        // Arrange
    ...
    @Test
    fun `getExercisesForWorkout_returnsExerciseLogs`() = runTest {
        // Arrange
    ...
    @Test
    fun `getSetsForExercise_returnsSetLogs`() = runTest {
        // Arrange
    ...
    @Test
    fun `insertExerciseLog_insertsAndReturnsId`() = runTest {
        // Arrange
    ...
    @Test
    fun `insertExerciseLogWithExerciseReference_byId_insertsAndReturnsId`() = runTest {
        // Arrange
    ...
    @Test
    fun `insertExerciseLogWithExerciseReference_byVariation_insertsAndIncrementsUsage`() = runTest {
        // Arrange
        coEvery { exerciseLogDao.insertExerciseLog(any()) } returns 5L
        coEvery { exerciseDao.incrementUsageCount(1L) } just runs
        
        // Act
        val result = repository.insertExerciseLogWithExerciseReference(
            workoutId = 1L,
    ...
    @Test
    fun `updateExerciseLog_updatesSuccessfully`() = runTest {
        // Arrange
    ...
    @Test
    fun `deleteExerciseLog_deletesSuccessfully`() = runTest {
        // Arrange
    ...
    @Test
    fun `deleteSetsForExercise_deletesAllSets`() = runTest {
        // Arrange
    ...
    @Test
    fun `updateExerciseOrder_singleExercise_updatesOrder`() = runTest {
        // Arrange
    ...
    @Test
    fun `updateExerciseOrder_multipleExercises_updatesAllOrders`() = runTest {
        // Arrange
    ...
    @Test
    fun `getExerciseDetailsForLog_returnsVariation`() = runTest {
        // Arrange
        coEvery { exerciseDao.getExerciseVariationById(1L) } returns mockVariation
