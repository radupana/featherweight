...
class OneRMServiceTest {
    ...
    fun `calculateConfidence caps reps at 15 for scoring`() {
        val confidence20Reps = service.calculateConfidence(
            reps = 20,
            rpe = 9f,
            percentOf1RM = 0.5f
        )
        
        val confidence15Reps = service.calculateConfidence(
            reps = 15,
            rpe = 9f,
            percentOf1RM = 0.5f
        )
    ...
    fun `calculateConfidence clamps percentOf1RM between 0 and 1`() {
        val confidenceOver = service.calculateConfidence(
            reps = 5,
            rpe = 9f,
            percentOf1RM = 1.5f
        )
        
        val confidenceAt1 = service.calculateConfidence(
            reps = 5,
            rpe = 9f,
            percentOf1RM = 1f
        )
        ...
        val confidenceNegative = service.calculateConfidence(
            reps = 5,
            rpe = 9f,
            percentOf1RM = -0.5f
        )
        
        val confidenceAt0 = service.calculateConfidence(
            reps = 5,
            rpe = 9f,
            percentOf1RM = 0f
        )
    ...
    fun `createOneRMRecord uses provided mostWeightData when available`() {
        ...
        val mostWeightData = OneRMService.MostWeightData(
            weight = 105f,
            reps = 3,
            rpe = 9f,
    ...
    fun `complete flow from set to 1RM record`() {
        ...
        val estimate = service.calculateEstimated1RM(
