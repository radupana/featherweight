...
class WorkoutTemplateWeightServiceTest {
    ...
    @Test
    fun `applyWeightSuggestions calculates weight from 1RM`() =
        runTest {
            // Arrange
            val workoutId = 1L
    ...
    @Test
    fun `applyWeightSuggestions uses different percentages for intensity levels`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val exerciseVariationId = 100L
    ...
    @Test
    fun `applyWeightSuggestions handles missing 1RM data`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val exerciseVariationId = 100L
    ...
    @Test
    fun `applyWeightSuggestions applies to all sets in exercise`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val exerciseVariationId = 100L
    ...
    @Test
    fun `applyWeightSuggestions handles multiple exercises`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val config =
    ...
    @Test
    fun `applyWeightSuggestions handles empty workout`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val config =
    ...
    @Test
    fun `applyWeightSuggestions preserves actual values in sets`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val exerciseVariationId = 100L
    ...
    @Test
    fun `applyWeightSuggestions estimates 1RM from recent history when no profile max`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val exerciseVariationId = 100L
    ...
    @Test
    fun `applyWeightSuggestions rounds weight to nearest 2_5kg`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val exerciseVariationId = 100L
    ...
    @Test
    fun `applyWeightSuggestions adjusts weight for different rep ranges`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val exerciseVariationId = 100L
    ...
    @Test
    fun `applyWeightSuggestions filters invalid sets from history`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val exerciseVariationId = 100L
    ...
    @Test
    fun `applyWeightSuggestions applies correct RPE multipliers`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val exerciseVariationId = 100L
    ...
    @Test
    fun `applyWeightSuggestions uses median for stability with multiple history sets`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val exerciseVariationId = 100L
    ...
    @Test
    fun `applyWeightSuggestions handles null targetReps with fallback`() =
        runTest {
            // Arrange
            val workoutId = 1L
            val exerciseVariationId = 100L
