...
class RemoteConfigServiceTest {
    ...
    @Test
    fun `getOpenAIApiKey - with valid key - returns key`() = runTest {
        // Arrange
    ...
    @Test
    fun `getOpenAIApiKey - with empty key - returns null and logs warning`() = runTest {
        // Arrange
    ...
    @Test
    fun `getOpenAIApiKey - with null string literal - returns null`() = runTest {
        // Arrange
    ...
    @Test
    fun `getOpenAIApiKey - with placeholder key - returns null`() = runTest {
        // Arrange
    ...
    @Test
    fun `getOpenAIApiKey - caches valid key for subsequent calls`() = runTest {
        // Arrange
    ...
    @Test
    fun `getOpenAIApiKey - does not cache invalid keys`() = runTest {
    ...
    @Test
    fun `getOpenAIApiKey - validates multiple invalid key formats`() = runTest {
    ...
    @Test
    fun `getOpenAIApiKey - accepts various valid key formats`() = runTest {
