...
class WorkoutRepositoryTest {
    ...
    @Test
    fun `insertWorkout delegates to dao`() =
        runTest {
            val workout =
                Workout(
    ...
    @Test
    fun `updateWorkout delegates to dao`() =
        runTest {
            val workout =
                Workout(
                    id = 1L,
    ...
    @Test
    fun `getWorkoutById returns workout from dao`() =
        runTest {
            val workoutId = 1L
            val expectedWorkout =
                Workout(
    ...
    @Test
    fun `getOngoingWorkout returns first in-progress workout`() =
        runTest {
            val ongoingWorkout =
                Workout(
                    id = 1L,
    ...
    @Test
    fun `getOngoingWorkout returns null when no ongoing workouts`() =
        runTest {
    ...
    @Test
    fun `deleteWorkout delegates to dao`() =
        runTest {
            val workoutId = 1L
    ...
    @Test
    fun `getExerciseLogsForWorkout returns logs from dao`() =
        runTest {
            val workoutId = 1L
            val expectedLogs =
                listOf(
    ...
    @Test
    fun `getSetsForWorkout returns all sets for workout`() =
        runTest {
            val workoutId = 1L
    ...
    @Test
    fun `completeWorkout updates status and processes data`() =
        runTest {
            val workoutId = 1L
    ...
    @Test
    fun `completeWorkout processes programme workout same as regular`() =
        runTest {
            val workoutId = 1L
            val workout =
                Workout(
    ...
    @Test
    fun `getWorkoutHistory returns summaries with statistics`() =
        runTest {
            val workout =
                Workout(
                    id = 1L,
    ...
    @Test
    fun `getExerciseHistory returns formatted history`() =
        runTest {
    ...
    @Test
    fun `getFilteredWorkouts applies date range filter`() =
        runTest {
    ...
    @Test
    fun `getWorkoutDayInfo returns correct counts`() =
        runTest {
    ...
    @Test
    fun `getRecentWorkoutsFlow returns flow from dao`() =
        runTest {
            val workouts =
                listOf(
    ...
    @Test
    fun `getWeeklyVolumeTotal calculates correct total`() =
        runTest {
            ...
            coEvery { exerciseLogDao.getExerciseLogsForWorkout(any()) } returns
                listOf(
                    ExerciseLog(id = 1L, workoutId = 1L, exerciseVariationId = 10L, exerciseOrder = 0),
                )
    ...
    @Test
    fun `getTrainingFrequency counts completed workouts`() =
        runTest {
    ...
    @Test
    fun `updateWorkoutTimer updates elapsed time and start time`() =
        runTest {
            val workoutId = 1L
            val workout =
                Workout(
    ...
    @Test
    fun `startWorkout creates new workout with correct fields`() =
        runTest {
            val expectedId = 42L
    ...
    @Test
    fun `markWorkoutInProgress updates status and timer`() =
        runTest {
            val workoutId = 1L
            val workout =
                Workout(
    ...
    @Test
    fun `markWorkoutInProgress skips update if already in progress`() =
        runTest {
            val workoutId = 1L
            val workout =
                Workout(
