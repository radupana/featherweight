...
class SmartSuggestionsTest {
    ...
    fun smartSuggestions_withAllFields_createsCorrectly() {
        ...
        val alternativeSuggestion1 = AlternativeSuggestion(
            reps = 8,
            weight = 60f,
            rpe = 7.5f,
            reasoning = "Lower reps for strength focus"
        )
        val alternativeSuggestion2 = AlternativeSuggestion(
            reps = 15,
            weight = 40f,
            rpe = 8.5f,
    ...
    fun smartSuggestions_equality_worksCorrectly() {
        ...
        val suggestions1 = SmartSuggestions(
            suggestedWeight = 50f,
            suggestedReps = 10,
            suggestedRpe = 8f,
        ...
        val suggestions2 = SmartSuggestions(
            suggestedWeight = 50f,
            suggestedReps = 10,
            suggestedRpe = 8f,
            lastWorkoutDate = date,
        ...
        val suggestions3 = SmartSuggestions(
    ...
    fun alternativeSuggestion_equality_worksCorrectly() {
        // Arrange
        val alternative1 = AlternativeSuggestion(
            reps = 10,
            weight = 50f,
            rpe = 7f,
            reasoning = "Standard"
        ...
        val alternative2 = AlternativeSuggestion(
            reps = 10,
            weight = 50f,
            rpe = 7f,
            reasoning = "Standard"
        ...
        val alternative3 = AlternativeSuggestion(
            reps = 10,
            weight = 50f,
            rpe = 7f,
