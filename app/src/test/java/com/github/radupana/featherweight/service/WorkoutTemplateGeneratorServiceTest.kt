...
class WorkoutTemplateGeneratorServiceTest {
    ...
    @Test
    fun `generateTemplate_pushWorkout_quickTime_returnsCorrectExercises`() = runTest {
        // Arrange
        val config = WorkoutTemplateGenerationConfig(
    ...
    @Test
    fun `generateTemplate_pullWorkout_standardTime_returnsCorrectExercises`() = runTest {
        // Arrange
        val config = WorkoutTemplateGenerationConfig(
    ...
    @Test
    fun `generateTemplate_legsWorkout_extendedTime_returnsCorrectExercises`() = runTest {
        // Arrange
        val config = WorkoutTemplateGenerationConfig(
            goal = TrainingGoal.STRENGTH,
    ...
    @Test
    fun `generateTemplate_upperBodyWorkout_quickTime_returnsCorrectExercises`() = runTest {
        // Arrange
        val config = WorkoutTemplateGenerationConfig(
            goal = TrainingGoal.HYPERTROPHY,
            time = TimeAvailable.QUICK,
    ...
    @Test
    fun `generateTemplate_fullBodyWorkout_standardTime_returnsCorrectExercises`() = runTest {
        // Arrange
        val config = WorkoutTemplateGenerationConfig(
            goal = TrainingGoal.HYPERTROPHY,
            time = TimeAvailable.STANDARD,
    ...
    @Test
    fun `generateTemplate_unknownTemplate_returnsEmptyList`() = runTest {
        // Arrange
        val config = WorkoutTemplateGenerationConfig(
            goal = TrainingGoal.STRENGTH,
            time = TimeAvailable.STANDARD,
    ...
    @Test
    fun `generateTemplate_strength_goal_returnsCorrectSetsAndReps`() = runTest {
        // Arrange
        val config = WorkoutTemplateGenerationConfig(
            goal = TrainingGoal.STRENGTH,
            time = TimeAvailable.QUICK,
    ...
    @Test
    fun `generateTemplate_muscleBuilding_goal_returnsCorrectSetsAndReps`() = runTest {
        // Arrange
        val config = WorkoutTemplateGenerationConfig(
            goal = TrainingGoal.HYPERTROPHY,
            time = TimeAvailable.QUICK,
    ...
    @Test
    fun `generateTemplate_beginner_skill_returnsFewerExercises`() = runTest {
        // Arrange
        val config = WorkoutTemplateGenerationConfig(
            goal = TrainingGoal.HYPERTROPHY,
            time = TimeAvailable.QUICK,
    ...
    @Test
    fun `generateTemplate_exerciseNotFound_skipsExercise`() = runTest {
        // Arrange
        val config = WorkoutTemplateGenerationConfig(
            goal = TrainingGoal.STRENGTH,
            time = TimeAvailable.QUICK,
