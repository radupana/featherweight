...
class FreestyleIntelligenceService(
    ...
    private suspend fun suggestMaintainOrDecrease(
        ...
        val suggestedWeight = if (progress.recentAvgRpe != null && progress.recentAvgRpe > 9.5f) {
    ...
    private suspend fun suggestBasedOnTrend(
        ...
        val (suggestedWeight, reasoning) = when (progress.trend) {
