...
interface ExerciseVariationDao {
    ...
    """)
    suspend fun getVariationsByCoreAndEquipment(coreExerciseId: Long, equipment: Equipment): List<ExerciseVariation>
    ...
    """)
    suspend fun getMostUsedVariationsByCore(coreExerciseId: Long, limit: Int): List<ExerciseVariation>
