...
class StallDetectionService(private val db: FeatherweightDatabase) {
    ...
    suspend fun analyzeStall(
        ...
        val isStalling = globalProgress.consecutiveStalls >= 3 || 
    ...
    fun getActionableSteps(recommendation: StallRecommendation): List<String> {
        return when (recommendation) {
            StallRecommendation.DELOAD -> listOf(
            ...
            StallRecommendation.CHANGE_REP_RANGE -> listOf(
            ...
            StallRecommendation.ADD_VARIATION -> listOf(
            ...
            StallRecommendation.INCREASE_FREQUENCY -> listOf(
            ...
            StallRecommendation.DECREASE_FREQUENCY -> listOf(
            ...
            StallRecommendation.TECHNIQUE_CHECK -> listOf(
            ...
            StallRecommendation.CONTINUE -> listOf(
