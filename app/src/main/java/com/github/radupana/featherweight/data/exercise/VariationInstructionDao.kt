...
interface VariationInstructionDao {
    ...
    suspend fun deleteInstructionsByType(variationId: Long, type: InstructionType)
    ...
    @Query("""
        ...
        ORDER BY orderIndex
    """)
    suspend fun getInstructionsByType(variationId: Long, type: InstructionType): List<VariationInstruction>
    ...
    @Query("""
        ...
        ORDER BY instructionType, orderIndex
    """)
    suspend fun getInstructionsByLanguage(variationId: Long, languageCode: String): List<VariationInstruction>
    ...
    @Query("""
        ...
        WHERE variationId = :variationId AND instructionType = :type
    """)
    suspend fun getInstructionCountByType(variationId: Long, type: InstructionType): Int
