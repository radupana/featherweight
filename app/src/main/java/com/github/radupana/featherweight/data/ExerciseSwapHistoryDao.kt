...
interface ExerciseSwapHistoryDao {
    ...
    """)
    suspend fun getSwapHistoryForExercise(userId: Long, originalExerciseId: Long): List<SwapHistoryCount>
    ...
    @Query("""
        ...
        LIMIT :limit
    """)
    suspend fun getRecentSwaps(userId: Long, limit: Int = 10): List<ExerciseSwapHistory>
}
